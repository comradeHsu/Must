...
impl Instruction for AReturn {
    ...
    fn execute(&mut self, frame: &mut Frame) {
        ...
        let invoke_frame = borrow.current_frame_mut();
        let return_value = current_frame.operand_stack().expect("stack is none")
            .pop_ref();
        invoke_frame.operand_stack().expect("stack is none").push_ref(return_value);
    }
}
...
impl Instruction for DReturn {
    ...
    fn execute(&mut self, frame: &mut Frame) {
        ...
        let return_value = current_frame.operand_stack().expect("stack is none")
            .pop_double();
        invoke_frame.operand_stack().expect("stack is none").push_double(return_value);
    }
}
...
impl Instruction for FReturn {
    ...
    fn execute(&mut self, frame: &mut Frame) {
        ...
        let return_value = current_frame.operand_stack().expect("stack is none")
            .pop_float();
        invoke_frame.operand_stack().expect("stack is none").push_float(return_value);
    }
}
...
impl Instruction for IReturn {
    ...
    fn execute(&mut self, frame: &mut Frame) {
        ...
        let return_value = current_frame.operand_stack().expect("stack is none")
            .pop_int();
        invoke_frame.operand_stack().expect("stack is none").push_int(return_value);
    }
}
...
impl Instruction for LReturn {
    ...
    fn execute(&mut self, frame: &mut Frame) {
        ...
        let return_value = current_frame.operand_stack().expect("stack is none")
            .pop_long();
        invoke_frame.operand_stack().expect("stack is none").push_long(return_value);
    }
}